...
const Button = ({ enabled, command, buttonText, buttonColor, extraStyles, activeOpacity, extraTextStyles, buttonTextColor, }) => {
    ...
    return (<TouchableOpacity onPress={enabled ? command : () => { }} style={{ ...styles.mainView, ...extraStyles }} activeOpacity={enabled && activeOpacity ? activeOpacity : 1}>
      <AnimatableText duration={400} animation={initialRender ? {} : enabled ? animations.buttonEnabled : animations.buttonDisabled} allowFontScaling={false} style={{
            ...styles.buttonText,
