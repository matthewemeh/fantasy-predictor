...
import { colors, findFontSize, DEVICE_WIDTH, DEVICE_HEIGHT, findScaledFontSize, } from '../utilities';
...
const InfoView = ({ type, infoName, infoText1, infoText2, infoValue1, infoValue2, }) => {
    const findColor = (index) => {
        if (infoValue1 === infoValue2)
