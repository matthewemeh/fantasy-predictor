...
interface Props {
  ...
  extraListStyles?: object;
  extraTextItemStyles?: object;
  extraSelectedValueStyles?: object;
  selectedItemHandler: React.Dispatch<React.SetStateAction<string>>;
}

const PickerBox: React.FC<Props> = ({
  list,
  enabled,
  extraStyles,
  selectedValue,
  ...
  return (
    ...
    >
      <AnimatableText
        ...
        animation={enabled ? animations.initialRender : animations.pickerDisabled}
        style={{
            ...
            <ScrollView>
              {list.map(item => (
                <TouchableOpacity
                  ...
                  onPress={item === selectedValue ? () => {} : () => onChange(item)}
                  style={{
                    ...styles.listItem,
