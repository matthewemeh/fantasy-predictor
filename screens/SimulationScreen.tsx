...
const SimulationScreen: React.FC<Props> = ({ visible }) => {
  ...
  // const adFitsContainer = 0.23 * 0.5 * DEVICE_HEIGHT >= DEFAULT_AD_HEIGHT;
  ...
  // useEffect(() => {
  //   if (clicks % 5 === 0 && !boardVisible && adLoaded) interstitial.show();
  // }, [clicks, boardVisible, adLoaded]);
